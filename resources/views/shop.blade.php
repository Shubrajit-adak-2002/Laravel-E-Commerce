...
@section('content')
                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="brand" value="{{ $brand->id }}"
                                                    class="chk-brand">
                                                @if (in_array($brand->id, explode(',', $filter_brands)))
                                                    checked="checked"
                                                @endif
                                            ...
                                            <span class="text-right float-end">
                                                <span
                                                    class="badge bg-light text-dark">{{ $brand->products->count() }}</span>
                                            </span>
                                        </li>
                                    @endforeach
                                </ul>
              ...
              "clickable": true
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Sort Items" name="total-number" style="padding: 10px" name="orderby"
                            id="orderby">
                        ...
                        <div class="product-card-wrapper">
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <form action="{{ route('wishlist.item.remove',['id'=>Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId]) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
    ...
    <form action="{{ route('shop.index') }}" id="form-filter" method="get">
        <input type="hidden" name="page" value="{{ $products->currentPage() }}">
        <input type="hidden" name="size" id="size" value="{{ $size }}">
        <input type="hidden" name="order" id="order" value="{{ $order }}">
        <input type="hidden" name="brands" id="brands">
        <input type="hidden" name="categories" id="categories">
        <input type="hidden" name="min" id="min_price" value="{{ $min_price }}">
        <input type="hidden" name="max" id="max_price" value="{{ $max_price }}">
    </form>
@endsection
@push('scripts')
    <script>
