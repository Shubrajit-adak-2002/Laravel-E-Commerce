            ...
            <table class="table table-striped table-bordered table-transaction">
                <tbody>
                    ...
                    <tr>
                        ...
                        @else
                            <td>No transaction data available</td>
                        @endif
                    </tr>
                </tbody>
            </table>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <select name="order_status" id="order_status">
                                <option value="ordered" {{ $order->status == 'orderd' ? 'selected' : '' }}>Ordered</option>
                                <option value="delivered" {{ $order->status == 'delivered' ? 'selected' : '' }}>Delivered
                                </option>
                                <option value="status" {{ $order->status == 'canceled' ? 'selected' : '' }}>Canceled
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3">
