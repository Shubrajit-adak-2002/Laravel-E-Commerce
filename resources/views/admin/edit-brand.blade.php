                ...
                <form class="form-new-product form-style-1" action="{{ route('admin.brand.update') }}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand name" name="name" tabindex="0"
                            value="{{ $brands->name }}" aria-required="true" required="">
                    </fieldset>
                    @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand Slug" name="slug" tabindex="0"
                            value="{{ $brands->slug }}" aria-required="true" required="">
                    </fieldset>
                    @error('slug')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
...
@push('scripts')
    <script>
        $(function() {
            // Update slug dynamically when name field changes
            ...
            // Mark slug as manually edited when the user types in it
