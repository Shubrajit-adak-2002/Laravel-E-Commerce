...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" method="POST" action="{{route('admin.coupon.create')}}">
                    @csrf
                    <fieldset class="name">
                    ...
                    @error('value') <span class="alert alert-danger">{{ $message }}</span> @enderror
                    <fieldset class="name">
                    ...
                    @error('cart_value') <span class="alert alert-danger">{{ $message }}</span> @enderror
                    <fieldset class="name">
                    ...
                    @error('expiry_date') <span class="alert alert-danger">{{ $message }}</span> @enderror
                    <div class="bot">
                        <div></div>
