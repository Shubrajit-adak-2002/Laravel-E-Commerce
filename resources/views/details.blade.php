        ...
        <section class="product-single container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    @else
                        <form name="addtocart-form" method="post" action="{{ route('cart.add-to-cart') }}">
                            @csrf
                    ...
                    <div class="product-single__addtolinks">
                        ...
                        <form action="{{ route('wishlist.item.remove',['id'=>Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId]) }}" method="post" id="remove-item">
                            @csrf
                            @method('DELETE')
                            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('remove-item').submit()"><svg
                            ...
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', ['product_slug' => $product->slug]) }}">
                                        ...
                                        @foreach (explode(',', $rproduct->images) as $img)
                                            <img loading="lazy"
                                                src="{{ asset('uploads/products') }}/{{ $img }}" width="330"
                                    ...
                                    @else
                                        <form name="addtocart-form" method="post"
                                            ...
                                            <input type="hidden" name="quantity" value="{{ $rproduct->name }}">
