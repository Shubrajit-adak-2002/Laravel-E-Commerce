                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <form action="{{route('logout')}}" method="post" id="logout">
                                        @csrf
                                        <a href="{{route('logout')}}" class="" onclick="event.preventDefault();document.getElementById('logout').submit()">
                                            <div class="icon"><i class="icon-settings"></i></div>
                        ...
                        <div class="wrap">
                            <div class="header-left">
                                ...
                                <form class="form-search flex-grow">
                                    <fieldset class="name">
                                        <input type="text" id="search" placeholder="Search here..." class="show-search" name="name"
